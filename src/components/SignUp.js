            ...
            <div className="flex justify-center items-center w-full h-auto bg-white p-12">
                <div className="flex h-auto shadow-lg shadow-gray-500 w-[53vmax]">
                    <div className="w-[23vmax] h-auto bg-blue-700 p-5 flex flex-col">
                        <div className="text-white text-3xl">Looks like you are new here!</div>
                        <br/>
                        <br/>
                        <div className="text-base text-white">Sign up with your mobile number to get started</div>
                    ...
                    <div className="w-[30vmax] h-auto bg-white flex flex-col p-6">
                        <form className="flex flex-col gap-2">
                            ...
                            }} className="text-base p-5 outline-none border border-gray-500 focus:border-blue-500" type="text"/>
                            ...
                            }} className="text-base p-5 outline-none border border-gray-500 focus:border-blue-500" type="password"/>
                            ...
                            <div className="flex flex-col mt-[5%]">
                                ...
                                <div className="flex justify-center items-center mt-[10%]">
                                    ...
                                    }} className="w-3/5 bg-orange-500 p-5 text-center text-white cursor-pointer">{!isLoading?"Sign Up":
